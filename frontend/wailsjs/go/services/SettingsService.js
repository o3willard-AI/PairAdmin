...
export function ChangeMasterPassword(arg1, arg2) {
  return window['go']['services']['SettingsService']['ChangeMasterPassword'](arg1, arg2);
}
...
export function LoadAPIKeys() {
  return window['go']['services']['SettingsService']['LoadAPIKeys']();
}

export function NeedsMasterPassword() {
  return window['go']['services']['SettingsService']['NeedsMasterPassword']();
}
...
export function SetMasterPassword(arg1) {
  return window['go']['services']['SettingsService']['SetMasterPassword'](arg1);
}
...
export function VerifyMasterPassword(arg1) {
  return window['go']['services']['SettingsService']['VerifyMasterPassword'](arg1);
}
